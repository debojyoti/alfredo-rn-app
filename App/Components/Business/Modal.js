  ...
  renderModalContent = () => (
    ...
    <Modal
      ...
      <View style={Styles.parentView}>
        ...
        <View style={[Styles.input1View, {marginTop: responsiveHeight(3)}]}>
          <Text>
            <Text style={Styles.parentText}>Address :</Text>
            <Text style={Styles.childText}> mz j lt 34</Text>
          </Text>
        </View>
        <View style={[Styles.input1View, {marginTop: responsiveHeight(3)}]}>
          <Text>
            <Text style={Styles.parentText}>Kind :</Text>
            <Text style={Styles.childText}> cards</Text>
          </Text>
        </View>
        <View style={[Styles.input1View, {marginTop: responsiveHeight(3)}]}>
          <Text>
            <Text style={Styles.parentText}>Name Business :</Text>
            <Text style={Styles.childText}> carWash</Text>
          </Text>
        </View>
        <View style={{marginTop: responsiveHeight(3)}}>
          <Text
            style={(Styles.childText, {width: '30%', alignSelf: 'flex-end'})}>
            Photo
          </Text>
          ...
          <LinearGradient
            ...
            <View
              ...
              <Text style={Styles.SwitchText}>
                {this.state.isSwitchOn ? 'Active' : null}
              </Text>
              <Switch
              ...
              />
              <Text style={Styles.SwitchText}>
                {this.state.isSwitchOn ? null : 'Not Active'}
              </Text>
            </View>
          </LinearGradient>
          <TouchableOpacity
