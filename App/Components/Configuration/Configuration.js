...
export default class Login extends Component {
  ...
  onSubmit = () => {
    const { linkfacebook, linktutorial, weeklycode, hashtag } = this.state;
    if (
      !validator.isEmpty(linkfacebook) &&
      !validator.isEmpty(linktutorial) &&
      !validator.isEmpty(weeklycode) &&
      ...
      <SafeAreaView style={Styles.container}>
        ...
        >
          ...
          <View style={{ flexDirection: "row" }}>
            <TouchableOpacity
              onPress={() =>
                this.setState({ Business: false, General: true, Advert: false })
              }
              style={{
                flex: 1,
            ...
            <TouchableOpacity
              onPress={() =>
                this.setState({ Business: true, Advert: false, General: false })
              }
              style={{
                flex: 1
              }}
            ...
            <TouchableOpacity
              onPress={() =>
                this.setState({ Advert: true, Business: false, General: false })
              }
              style={{
                flex: 1
              }}
