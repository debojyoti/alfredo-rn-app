      ...
      <View style={Styles.middleCheckBoxView}>
        ...
        >
          <View style={Styles.TableHeadingView}>
            ...
            <Text style={Styles.TableheadingText}>Address ETH</Text>
          </View>
          <View style={Styles.TableContentView}>
            ...
            <Text style={Styles.TableContentText}>{item.amount}</Text>
            <Text style={Styles.TableContentText}>{item.date}</Text>
            <Text style={Styles.TableContentText}>{item.AddressETH}</Text>
          </View>
        </TouchableOpacity>
      </View>
    );
