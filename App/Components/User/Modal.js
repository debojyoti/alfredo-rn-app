...
export default class Wallet extends Component {
  ...
  closeModal = () => {
    this.setState({ visible: false, ModalState: false });
  };
  renderModalContent = () => (
        ...
        <View style={Styles.GradientSuperView}>
          <View style={Styles.ParentFlexView1}>
            <View style={Styles.nested1}>
              <Text style={Styles.GradientText}>Current packages</Text>
              <LinearGradient
          ...
          <View style={Styles.ButtonFlexView1}>
            <Button
              onPress={() => {
                this.setState({
                  ModalState: true,
                  modalMessage: "Estas seguro que quieres eliminar este usuario"
                });
              }}
            ...
            <Button
              onPress={() => {
                this.setState({
                  ...
                  showCheckBox: true,
                  modalMessage:
                    "Estas seguro que quieres bloquear los botones de compra y venta para este usuario?"
                });
              }}
              style={Styles.GivetButton}
              contentStyle={{ height: responsiveHeight(4) }}
            ...
            <Button
              onPress={() => {
                this.setState({
                  ModalState: true,
                  modalMessage:
                    "Estas seguro que quieres renviar correo a este usuario"
                });
              }}
              style={Styles.GivetButton}
              contentStyle={{ height: responsiveHeight(4) }}
...
const Styles = StyleSheet.create({
  ...
  textCheck: { alignSelf: "center", color: "white" },
  TopView: {
