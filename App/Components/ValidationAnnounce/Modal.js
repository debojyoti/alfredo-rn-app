  ...
  renderModalContent = () => (
    <View style={Styles.modalView}>
      ...
      <View style={Styles.parentView}>
        ...
        <View style={[Styles.input1View, {marginTop: responsiveHeight(3)}]}>
          <Text>
            <Text style={Styles.parentText}>Address Post :</Text>
            <Text style={Styles.childText}> facebook.com/givet</Text>
          </Text>
        </View>
        <View style={[Styles.input1View, {marginTop: responsiveHeight(3)}]}>
          <Text>
            <Text style={Styles.parentText}>publication date :</Text>
            <Text style={Styles.childText}> 20/03/2020</Text>
          </Text>
        </View>
          ...
          <LinearGradient
            ...
            <View
              ...
              <Text style={Styles.SwitchText}>
                {this.state.isSwitchOn ? 'Not Validate' : null}
              </Text>
              <Switch
              ...
              />
              <Text style={Styles.SwitchText}>
                {this.state.isSwitchOn ? null : 'Validate'}
              </Text>
            </View>
          </LinearGradient>
          <TouchableOpacity
